describe('Organic.mixCollectionMethods', function () {
    'use strict';

    beforeEach(function () {
        this.data = [1, 2, 3];
        this.doubledData = [2, 4, 6];
        this.double = function (v) {
            return v * 2;
        };
    });
    ...
    describe('object literal', function () {
        beforeEach(function () {
            ...
            Organic.mixCollectionMethods(this.target, 'list');
    ...
    describe('function prototype', function () {
        beforeEach(function () {
            this.Class = function (list) {
                this.list = list;
            };
            Organic.mixCollectionMethods(this.Class.prototype, 'list');
