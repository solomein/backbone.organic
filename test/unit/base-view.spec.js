describe('Organic.BaseView', function () {
    'use strict';
    ...
    describe('when creating a view', function () {
        ...
        it('should call the Backbone.View constructor', function () {
    ...
    describe('constructing a view with default options', function () {
        beforeEach(function () {
            ...
            this.View = Organic.BaseView.extend();
            this.ViewPresets = Organic.BaseView.extend({options: this.presets});
            this.ViewPresetsFn = Organic.BaseView.extend({options: this.presetsStub});
        });
    ...
    describe('should expose its options in the constructor', function () {
        beforeEach(function () {
            this.options = {foo: 'bar'};
            this.view = new Organic.BaseView(this.options);
        });
