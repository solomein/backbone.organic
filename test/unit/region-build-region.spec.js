describe('Region', function () {
    describe('.buildRegion', function () {
        beforeEach(function () {
            this.DefaultRegionClass = Organic.Region.extend();

            this.fooSelector = '#foo-region';
            this.fooRegion = new this.DefaultRegionClass({
                el: this.fooSelector
            });

            this.barSelector = '#bar-region';
            this.BarRegion = Organic.Region.extend({
                el: this.barSelector
            });
            this.barRegion = new this.BarRegion();

            this.BazRegion = Organic.Region.extend();
        });

        describe('with a selector string', function () {
            beforeEach(function () {
                this.region = Organic.Region.buildRegion(this.fooSelector, this.DefaultRegionClass);
            });
        ...
        describe('with a region class', function () {
            describe('with `el` defined', function () {
                beforeEach(function () {
                    this.region = Organic.Region.buildRegion(this.BarRegion, this.DefaultRegionClass);
                });
            ...
            describe('without `el` defined', function () {
                beforeEach(function () {
                    ...
                    this.buildRegion = function () {
                        Organic.Region.buildRegion(this.BarRegion, this.DefaultRegionClass);
                    }.bind(this);
                });
        ...
        describe('with an object literal', function () {
            describe('with `selector` defined', function () {
                beforeEach(function () {
                    ...
                    this.region = Organic.Region.buildRegion(this.definition, this.DefaultRegionClass);
                });
            ...
            describe('with `el` defined', function () {
                ...
                describe('when el is an HTML node', function () {
                    beforeEach(function () {
                        ...
                        this.bazRegion = new this.DefaultRegionClass({
                            el: this.el
                        });
                        this.definition = {
                            el: this.el
            ...
            describe('when el is an empty jQuery object', function () {
                beforeEach(function () {
                    ...
                    this.buildRegion = function () {
                        Organic.Region.buildRegion(this.definition, this.DefaultRegionClass);
                    }.bind(this);
                });
            ...
            describe('with `regionClass` defined', function () {
                ...
                describe('with `el` also defined', function () {
                    beforeEach(function () {
                        ...
                        this.region1Definition = _.defaults({
                            el: this.fooSelector
                        }, this.baseDefinition);
                        this.region2Definition = _.defaults({
                            el: this.el
                        }, this.baseDefinition);
                        this.region3Definition = _.defaults({
                            el: this.$el
                        }, this.baseDefinition);

                        this.baz1Region = new this.BazRegion({
                            el: this.fooSelector
                        });
                        this.baz2Region = new this.BazRegion({
                            el: this.el
                        });
                        this.baz3Region = new this.BazRegion({
                            el: this.$el
                        });

                        this.region1 = Organic.Region.buildRegion(this.region1Definition, this.DefaultRegionClass);
                        this.region2 = Organic.Region.buildRegion(this.region2Definition, this.DefaultRegionClass);
                        this.region3 = Organic.Region.buildRegion(this.region3Definition, this.DefaultRegionClass);
                    });
            ...
            describe('with additional region options', function () {
                beforeEach(function () {
                    ...
                    this.region = Organic.buildRegion(this.definition, this.DefaultRegionClass);
                });
        ...
        describe('with an improper object literal', function () {
            ...
            it('throws an error', function () {
                expect(this.buildRegion).to.throw('Improper region configuration type.');
            });
        });
    });
});
