describe('Organic.RegionManager', function () {
    'use strict';
    ...
    describe('.addRegion', function () {
        describe('with a name and selector', function () {
            beforeEach(function () {
                ...
                this.regionManager = new Organic.RegionManager();
        ...
        describe('and with a name and el', function () {
            beforeEach(function () {
                this.buildSpy = sinon.spy(Organic.Region, 'buildRegion');
                this.$el = $('<div>');
        ...
        describe('and with an improper object literal', function () {
            beforeEach(function () {
                var regionManager = new Organic.RegionManager();
            ...
            it('throws an error', function () {
                expect(this.addRegion).to.throw('Improper region configuration type.');
            });
        });
    });
    ...
    describe('.addRegions', function () {
        ...
        describe('with region instance', function () {
            beforeEach(function () {
                this.fooRegion = new Organic.Region({
                    el: '#foo'
                });
                this.regionManager = new Organic.RegionManager();
        ...
        describe('with a function', function () {
            ...
            describe('without defaults', function () {
                beforeEach(function () {
                    ...
                    this.barRegion = new Organic.Region({
                        el: this.barSelector
                    });
                    this.BazRegion = Organic.Region.extend();
                    this.bazRegion = new this.BazRegion({
                        el: this.bazSelector
                    });
            ...
            describe('with defaults', function () {
                beforeEach(function () {
                    ...
                    this.fooRegion = new this.BazRegion({
                        el: this.fooSelector
                    });
                    this.barRegion = new this.BazRegion({
                        el: this.barSelector
                    });
    ...
    describe('.removeAllRegions', function () {
        beforeEach(function () {
            ...
            this.sinon.spy(this.regionManager, 'removeAllRegions');
            this.regionManager.removeAllRegions();
        });
    ...
    describe('when iterating the region manager', function () {
        beforeEach(function () {
            ...
            this.rm = new Organic.RegionManager();
