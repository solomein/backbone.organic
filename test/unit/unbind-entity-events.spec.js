describe('Organic.unbindEntityEvents', function () {
    'use strict';
    ...
    describe('when entity isn\'t passed', function () {
        beforeEach(function () {
            Organic.unbindEntityEvents(this.target, false, {'foo': 'foo'});
        });
    ...
    describe('when bindings isn\'t passed', function () {
        beforeEach(function () {
            Organic.unbindEntityEvents(this.target, this.entity, null);
        });
    ...
    describe('when binding is a function', function () {
        beforeEach(function () {
            ...
            Organic.unbindEntityEvents(this.target, this.entity, this.bindingsSpy);
        });
    ...
    describe('when bindings is an object with one event-handler pair', function () {
        describe('when handler is a function', function () {
            beforeEach(function () {
                Organic.unbindEntityEvents(this.target, this.entity, {'foo': this.target.foo});
            });

            it('should unbind an event', function () {
                expect(this.stopListeningStub)
                    .to.have.been.calledOnce.and.calledWith(this.entity, 'foo', this.target.foo);
            });
        });
        ...
        describe('when handler is a string', function () {
            describe('when one handler is passed', function () {
                beforeEach(function () {
                    Organic.unbindEntityEvents(this.target, this.entity, {'foo': 'foo'});
                });
            ...
            describe('when multiple handlers are passed', function () {
                beforeEach(function () {
                    Organic.unbindEntityEvents(this.target, this.entity, {'baz': 'foo bar'});
                });
    ...
    describe('when bindings is an object with multiple event-handler pairs', function () {
        beforeEach(function () {
            Organic.unbindEntityEvents(this.target, this.entity, {
                'foo': 'foo',
                'bar': 'bar'
            });
        });
    ...
    describe('when unbindEntityEvents is proxied', function () {
        beforeEach(function () {
            this.target.unbindEntityEvents = Organic.proxyUnbindEntityEvents;
